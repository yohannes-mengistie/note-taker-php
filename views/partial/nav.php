        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/" class="<?php if(urlIs('/')) {echo 'bg-gray-900 text-white' ;} ?> text-gray-300 rounded-md px-3 py-2 text-sm font-medium " aria-current="page">Home</a>
              <a href="/about" class="<?php if(urlIs('/about'))  {echo 'bg-gray-900 text-white';} ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">About</a>
              <a href="/notes" class="<?php if(urlIs('/notes'))  {echo 'bg-gray-900 text-white';} ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Notes</a>
              <a href="/contact" class="<?php if(urlIs('/contact'))  {echo 'bg-gray-900 text-white';} ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Contact</a>
